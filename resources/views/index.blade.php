<x-app-layout>
    ...
    <div id="item-1" class="col-sm-10 col-lg-8 px-sm-4 mx-sm-4 px-lg-5 mx-lg-5" style="margin-top: 10%;">
        <h1 class="cs_request pb-lg-4">信頼を重ねた河村工芸</h1>
        <p class="lead">
            河村工芸は、先代 河村孝によって1941年に神戸で創業しました。<br>
            若干18歳で親方となった孝ですが、最初から上手くいくことはありませんでした。<br>
            それでも誠実に仕事と向き合い、信頼を重ねることで歴史を積み上げてきました。<br>
            そんな孝の口癖が、<span style="font-weight: bold;">「嘘をつくな・約束を守れ・時間を守れ・仕事命」</span>でした。<br>
            <br>
            2000年に2代目 興一に代替わりをしてからもこの想いは引き継がれています。<br>
            これからも誠実であることを大切にし、お客様が満足できる空間づくりのお手伝いを果たします。
